import { BarChart, BarChart3, Calendar, ChevronDown, CreditCard, FileText, LayoutDashboard, MessageSquare, Package, Settings, ShoppingBag, User, Zap } from 'lucide-react';
  ...
  return(
    <div
     className={`${
      ...
      `}
      >
      <div className=' w-72 p-6 border-b border-slate-200/50 dark:border-slate-700/50'>
